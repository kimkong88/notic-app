...
function setInitialContentFromMarkdown(
...
/** Keep read-only viewer in sync when content is updated externally (e.g. editing in PiP / EditorModal). */
function SyncExternalContentPlugin({ content }: { content: string }) {
    const [editor] = useLexicalComposerContext();
    ...
    return (
        ...
        >
            <LexicalComposer initialConfig={initialConfig}>
                ...
                {readOnly && (
                    <SyncExternalContentPlugin content={initialContent} />
                )}
                ...
                {!readOnly && (
                    <>
                        ...
                        <RegisterFlushRefPlugin
                            onFlush={onFlush}
                            registerFlushRef={registerFlushRef}
                        />
                    </>
                )}
                <ListPlugin />
